...
/**
 * This is the model class for table "{{paypal_response}}".
 *
 * The followings are the available columns in table '{{paypal_response}}':
...
class PaypalResponse extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('response_invoice_id, response_payer_id, response_payment_status, response_payment_type, response_txn_id, response_mc_gross, response_mc_fee, response_real_fee, response_payer_email, response_payer_status, response_mc_currency, customer_id, order_id, response_create_at', 'required'),
			array('response_invoice_id, customer_id, order_id', 'numerical', 'integerOnly'=>true),
			array('response_mc_gross, response_mc_fee, response_real_fee', 'numerical'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'response_payment_status' => 'Response Payment Status',
			'response_payment_type' => 'Response Payment Type',
			'response_txn_id' => 'Response Txn',
			'response_mc_gross' => 'Response Mc Gross',
