...
class Realypay extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('realypay_siteid, realypay_total, realypay_status, realypay_transactionid, realypay_verifycode, realypay_customerid, realypay_orderid, realypay_createat', 'required'),
